...
This simple trackers, simply assigns track IDs which maximise the 'bounding box IoU' between previous tracks and current
...
config = {
    ...
    'OUTPUT_FOL': os.path.join(code_path, 'data/trackers_legacy/rob_mots/{split}/STP/data/'),
...
def track_sequence(seq_file):
    ...
    for cls, cls_data in data.items():
        ...
        # Run trackers for each timestep.
...
if __name__ == '__main__':
    ...
    # Obtain list of sequences to run trackers for.
