...
class _BaseDataset(ABC):
    ...
    def get_display_name(self, tracker):
        """ Can be overwritten if the trackers_legacy name (in files) is different to how it should be displayed.
    ...
    def get_raw_seq_data(self, tracker, seq):
        """ Loads raw data (trackers and ground-truth) for a single trackers on a single sequence.
