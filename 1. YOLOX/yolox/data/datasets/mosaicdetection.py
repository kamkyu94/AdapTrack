...
class MosaicDetection(Dataset):
    ...
    def __getitem__(self, idx):
        if self.enable_mosaic:
            ...
            if len(mosaic_labels):
                ...
                # Added (Clip) - Uncomment for mot20 and dance
    ...
    def mixup(self, origin_img, origin_labels, input_dim):
        ...
        # Added (Clip) - Uncomment for mot20 and dance
        cp_bboxes_transformed_np[:, 0::2] = np.clip(cp_bboxes_transformed_np[:, 0::2], 0, target_w)
        cp_bboxes_transformed_np[:, 1::2] = np.clip(cp_bboxes_transformed_np[:, 1::2], 0, target_h)
